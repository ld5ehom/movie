...
export class Component {
  constructor(payload = {}) {
    const {
      tagName = 'div', // 최상위 요소의 태그 이름, default value = div 
      props = {},
      state = {}
    } = payload
    this.el = document.createElement(tagName) // component의 최상위 요소
    this.props = props // component가 사용될 때 부모 component에서 받는 데이터
    this.state = state // component 안에서 사용할 데이터
    this.render()
  }
  render() { // component를 렌더링하는 함수
    // ...
  }
}
